    ...
    if args_cli.record_side is not None:
        if args_cli.record_side != "both":
            isolate_comparison_side(
                ...
                (
                    "/Visuals/NearFarCurrent7",
                    "/Visuals/NearFarTarget7",
                    "/Visuals/NearFarCommandForce7",
                    "/Visuals/NearFarMeasuredForce7",
                ),
                (
                    "/Visuals/NearFarCurrent9",
                    "/Visuals/NearFarTarget9",
                    "/Visuals/NearFarCommandForce9",
                    "/Visuals/NearFarMeasuredForce9",
                ),
            )
        sides = (
